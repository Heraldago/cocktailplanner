...
export const EquipmentCard: React.FC<EquipmentCardProps> = ({
  ...
  return (
    <div className="w-full bg-[#FFFFFF] border-4 border-[#121212] shadow-[8px_8px_0px_0px_#121212] p-5 sm:p-7 relative flex flex-col justify-between">
      {/* Decorative corner */}
      <div className="absolute -top-3 -right-3 w-7 h-7 bg-[#1040C0] border-2 border-[#121212] shadow-[2px_2px_0px_0px_#121212]" />

      <div>
        {/* Header */}
        <div className="flex items-center gap-3 pb-4 border-b-4 border-[#121212]">
          <div className="p-2.5 bg-[#1040C0] text-white border-2 border-[#121212] shadow-[3px_3px_0px_0px_#121212]">
            <Wrench className="w-6 h-6" />
          </div>
          <div>
            <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[#121212]">
              Utensili & Alternative DIY
            </h3>
            <p className="text-xs sm:text-sm font-medium text-[#121212]/80">
              Nessun set da bar costoso richiesto: ecco come arrangiarsi con ciò che hai in cucina
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4">
          <div className="bg-[#F0F0F0] border-2 border-[#121212] p-3 shadow-[2px_2px_0px_0px_#121212]">
            ...
            <span className="text-base font-black text-[#121212] uppercase leading-tight mt-0.5 block">
              {technique}
            </span>
          </div>
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 flex items-center justify-center bg-[#1040C0] text-white text-xs font-black">
                      {idx + 1}
                    </span>
      ...
      {/* Pro tip footer */}
      <div className="mt-5 p-3 bg-[#F0F0F0] border-2 border-[#121212] text-xs font-medium text-[#121212]">
        <strong>💡 Regola d'oro del bartender casalingo:</strong> Raffredda sempre i bicchieri in frigorifero o con cubetti di ghiaccio prima di versare il drink per non sciogliere il ghiaccio troppo in fretta.
      </div>
    </div>
  );
};
